...
- The prover gives away their knowledge
- The verifier does as much work as the prover
...
Since the numbers are already on a field, we can:
...
The EC pairing function $e(P, Q)$ is a bilinear mapping of the curve points $e: G_1 \times G_2 \rightarrow G_T$

### Properties

Let $G_1$, $G_2$ and $G_T$ be the generator point of group 1, 2 and target respectively.

$e(aG_1, bG_2) = e(abG_1, G_2) = e(G_1, abG_2) = abG_T$
> $a \cdot b = ab \cdot 1 = 1 \cdot ab$

$e((a + b)G_1, cG_2) = e(aG_1, cG_2) + e(bG_1, cG_2) = (a + b)cG_T$
> $(a + b) \cdot c = ac + bc$
...
Because the prover knows $x$, they can know the entire sequence of
$a_0, a_1, ..., a_n$
...
1. The 1022nd element in $s_i$ is $2338775057G_1$
2. $e(a_iG_1, a_iG_2) + e(a_{i+1}G_1, a_{i+1}G_2) = e(a_{i+2}G_1, G_2)$
    >$a_i^2 + a_{i+1}^2 = a_{i+2} \cdot 1$
3. $e(a_iG_1, G_2) = e(G_1, a_iG_2)$
